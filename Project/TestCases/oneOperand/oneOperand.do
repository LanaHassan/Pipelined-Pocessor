...
vsim work.corei9
mem load -i {D:/Project/TestCases/oneOperand/oneOperand.mem} /corei9/InstMemory/ram
mem load -i {D:/Project/TestCases/oneOperand/oneOperandDataMemory.mem} /corei9/DataMemory/ram
...
force -freeze sim:/corei9/InPort 16'h0005 0
run
run
run
run
force -freeze sim:/corei9/InPort 16'h0004 0
run
force -freeze sim:/corei9/InPort 16'h0007 0
run
run
run
run
force -freeze sim:/corei9/InPort 16'h0001 0
run
force -freeze sim:/corei9/InPort 16'h0003 0
run
run
run
run
