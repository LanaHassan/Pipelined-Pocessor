...
vsim work.corei9
mem load -i {D:/Project/TestCases/Cod1.mem} /corei9/InstMemory/ram
mem load -i {D:/Project/TestCases/Cod1DataMemory.mem} /corei9/DataMemory/ram
...
run
run
force -freeze sim:/corei9/InPort 16'h1111 0
run
run
run
run
